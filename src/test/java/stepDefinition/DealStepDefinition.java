...
public class DealStepDefinition {
	...
	public void user_enters_deal_details(DataTable dealdata) throws Throwable {
	  ...
	  List<List<String>>  ddata=dealdata.raw();
	  Thread.sleep(2000);
	  driver.findElement(By.id("title")).sendKeys(ddata.get(0).get(0));
	  driver.findElement(By.id("amount")).sendKeys(ddata.get(0).get(1));
	  driver.findElement(By.id("probability")).sendKeys(ddata.get(0).get(2));
	  driver.findElement(By.id("commission")).sendKeys(ddata.get(0).get(3));

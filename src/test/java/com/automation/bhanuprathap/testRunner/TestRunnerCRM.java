...
@CucumberOptions( features= "/Users/pmanala/workspace_New/automationCucumber/src/test/java/featuresFileNew/CRM.feature",
...
plugin={"json:jsonReport/json.json",
		   ...
		   "rerun:rerunReport.txt"}  //64299920 Battu7211@

)
public class TestRunnerCRM extends AbstractTestNGCucumberTests{

 ...
 * 3.Run cucumber feature file parallel by using pom.xml
 *  
 *    <plugin>
				...
				<configuration>
					...
					<includes>
						<include>**//*RunnerCRM.java</include> (Remove one slash in **//*RunnerCRM.java)
					</includes>
				</configuration>
			</plugin>
 * 4.We can use TestNG.xml also to run parallel
 */
//@RunWith(Cucumber.class)
@CucumberOptions(features= "/Users/pmanala/workspace_New/automationCucumber/src/test/java/featuresFileNew",
...
public class RunAllFeaturefFilesATaTime extends AbstractTestNGCucumberTests{

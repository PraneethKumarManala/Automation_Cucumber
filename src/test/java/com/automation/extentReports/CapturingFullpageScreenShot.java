...
public class CapturingFullpageScreenShot {
	...
	public void startReport() {
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir")+"/MyOwnReports/FullPageCaptureExtentReport.html");
	...
	public void getResult(ITestResult result) throws IOException {
		...
		if(result.getStatus()==ITestResult.FAILURE) {
			...
			String screenshotPath=GetFullPageScreenShot.captureFullPage(driver, "MyFullPageScreenShot");
